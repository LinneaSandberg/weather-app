...
export const averageTemp_Mockdata = {
    current: {},
    daily: {
...
export const averageTemp_badMockdata = {
    current: {},
    daily: {
...
export const getWeatherCodes_mockdata = {
    current: {},
    daily: {
        temperature_2m_max: [],
        temperature_2m_min: [],
...
export const getIcon_badMockdata = {
    current: {},
    daily: {
        temperature_2m_max: [],
        temperature_2m_min: [],
...
export const getIcon_emptyMockdata = {
    current: {},
    daily: {
        temperature_2m_max: [],
        temperature_2m_min: [],
...
export const getSunriseAndSunset_Mockdata = {
    current: {},
    daily: {
        temperature_2m_max: [],
        temperature_2m_min: [],
